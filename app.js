...
const songs = [
    ...
    {
        id: 11,
        songName: `DON'T UNDERSTAND
    <br>
    <div class="subtitle">Alien X</div>`,
        poster: "Images/11.jpg",
    },
    {
        id: 12,
        songName: `Royalty don diablo
    <br>
    <div class="subtitle">Four Arms</div>`,
    ...
    {
        id: 17,
        songName: `cricket-we-nice
    <br>
    <div class="subtitle">MSpider Monkey</div>`,
    ...
    },
    {
        ...
        songName: `getaway
    <br>
    <div class="subtitle">MangoMan</div>`,
        poster: "Images/18.jpg",
    },
    {
        id: 19,
        songName: `king-of-the-hill
    <br>
    <div class="subtitle">Black heart </div>`,
        poster: "Images/19.jpg",
    },
    {
        id: 20,
        songName: `Now im broken
    <br>
    <div class="subtitle">Love hunter </div>`,
...
input.addEventListener('keyup', () => {
    ...
    for (let index = 0; index < items.length; index++) {
        ...
        if (input.value == 0) {
            search_result.style.display = "none";   //     issue
        } else {
            search_result.style.display = "";        //     issue
...
const makeAllBackground = () => {
    Array.from(document.getElementsByClassName('songItem')).forEach((el) => {
        el.style.background = 'rgb(105, 105, 105, .0)';                                // issue
    });
};
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;                                                        //     issue
        // console.log(index);
        music.src = `Songs/${index}.mp3`;
        poster_master_play.src = `Images/${index}.jpg`;                    //     issue
        music.play();
        masterPlay.classList.remove('fa-play');
        masterPlay.classList.add('fa-pause');
        download_music.href = `Songs/${index}.mp3`;                          //     issue
        ...
        makeAllBackground();
        Array.from(document.getElementsByClassName('songItem'))[index - 1].style.background = "rgb(105, 105, 105, .1)";  //     issue
        makeAllplays();
        el.target.classList.remove('fa-circle-play');                     //     issue
        el.target.classList.add('fa-circle-pause');                //     issue
        wave.classList.add('active1'); 
